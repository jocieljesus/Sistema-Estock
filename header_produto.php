...
<div class="banner">
	...
	<nav class="navbar navbar-light bg-light">
		<form class="form-inline" method="POST" action="http://localhost/estock-master/produto_search.php">
			<input class="form-control mr-sm-2" type="text" name="nomeproduto" placeholder="Pesquisar produto" aria-label="Pesquisar">
			<button type="submit" name="SendPesqUser" class="btn btn-outline-light"><i class="fa fa-search" style="color:#666666"></i></button>
		</form>

		<ul class="nav justify-content-end">
			<li class="nav-item">
				<a class="nav-link active" href="http://localhost/estock-master/estoque.php"><b>Estoque</b></a>
			</li>
			<li class="nav-item">
