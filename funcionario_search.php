					...
					<div class="col-md-12">
						<table class="table">
							...
							<tbody>
								...
								<?php while($rows_funcionario = mysqli_fetch_assoc($resultado_search)){ ?>
									<tr>
										...
										<td>
											<button type="button" class="buttonacao-3"  data-toggle="modal" data-target="#ModalDelFunc<?php echo $rows_funcionario['id']; ?>" data-whatever="<?php echo $rows_funcionario['id']; ?>"><img src="images/del.png"></button>	
										</td>
