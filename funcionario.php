		...
		<div class="container theme-showcase" role="main">
			<div class="page-header">				
				...
				if($_SESSION['permissao']=="1"){?>
					...
					<h1><img src="images/etiqueta.png" style="margin-right: 5px">Listar Funcionário</h1>
				<?php } ?>
			</div>
						...
						<tbody>
							<?php while($rows_funcionario = mysqli_fetch_assoc($resultado_funcionario)){ ?>
								<tr>
									...
									<td>
										<button type="button" class="buttonacao-1" data-toggle="modal" data-target="#ModalShowFunc<?php echo $rows_funcionario['id']; ?>" style="padding-top: 0px;"><img src="images/procurar.png"></button>
									</td>
									<?php if($_SESSION['permissao']=="1"){?>
									<td>	
										<button type="button" class="buttonacao-2" data-toggle="modal" data-target="#editFunc<?php echo $rows_funcionario['id']; ?>" ><img src="images/config.png"></button>
									</td>
									<td>
										<button type="button" class="buttonacao-3"  data-toggle="modal" data-target="#ModalDelFunc<?php echo $rows_funcionario['id']; ?>" data-whatever="<?php echo $rows_produto['id']; ?>"><img src="images/del.png"></button>	
									</td>
								<?php } ?>
