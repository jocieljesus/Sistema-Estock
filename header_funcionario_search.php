<div class="banner">
	...
	<nav class="navbar navbar-light bg-light" style="margin-bottom: 0px;">
		<form class="form-inline" method="POST" action="http://localhost/estock-master/funcionario_search.php">
			<input class="form-control mr-sm-2" type="text" name="nomeproduto" placeholder="Pesquisar funcionario" aria-label="Pesquisar">
		...
		<ul class="nav justify-content-end">
			...
			<li class="nav-item">
				<a class="nav-link" href="http://localhost/estock-master/estoque.php"><b>Estoque</b></a>
			</li>
			<li class="nav-item">
